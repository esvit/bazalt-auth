...
class UserSetting extends Base\UserSetting
{
    ...
    {
        $q = ORM::select('Bazalt\Login\Model\UserSetting s')
    ...
    {
        $q = ORM::delete('Bazalt\Login\Model\UserSetting u')
    ...
    {
        $q = ORM::select('Bazalt\Login\Model\UserSetting s', 'COUNT(*) as count')
