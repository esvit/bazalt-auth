...
abstract class User extends \Bazalt\ORM\Record
{
    ...
    const MODEL_NAME = 'Bazalt\Login\Model\User';
    ...
    {
        $this->hasRelation('Roles', new \Bazalt\ORM\Relation\Many2Many('Bazalt\Login\Model\Role', 'user_id', 'Bazalt\Login\Model\RoleRefUser', 'role_id'));
        $this->hasRelation('Settings', new \Bazalt\ORM\Relation\One2Many('Bazalt\Login\Model\UserSetting', 'id', 'user_id'));
    }
